...
#'      and Piecewise Linear FNs (see e.g. \code{\link{expectedValue-methods}},
#'      \code{\link{value-methods}}, \code{\link{trapezoidalApproximation-methods}},
#'      \code{\link{piecewiseLinearApproximation-methods}}),
#'    \item Visualization of FNs (see \code{\link{plot-methods}}),
